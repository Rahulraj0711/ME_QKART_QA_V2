...
public class Login {
    ...
    public Boolean PerformLogin(String Username, String Password) throws InterruptedException {
        ...
        FluentWait<RemoteWebDriver> fWait = new FluentWait<RemoteWebDriver>(driver).withTimeout(Duration.ofSeconds(30)).pollingEvery(Duration.ofMillis(250));
        fWait.until(ExpectedConditions.invisibilityOf(login_button));
